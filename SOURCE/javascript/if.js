/**
 * 조건문, 선택문
 * 조건의 결과가 true(참)일 경우에만, 코드 실행
 * 조건연산자 : (조건식) ? 
 * 
 * //나이(age)가 19세 이상 ? age>19
 * 참 --> "성인" 출력, 
 * 거짓 --> "미성년자" 출력
 */
let age= 20; 
...
result = Boolean(3==='3') //flase
result = Boolean('hello');//true
result = Boolean(''); // false, '', 0, null
console.log( "결과는", result);


//변수에 숫자를 하나 저장 후 양수인지, 음수인지, 0인지 구분
//조건이 숫자>0
//참 --> 양수 출력
//거짓 --> 숫자 < 0
//    --> 참 : 음수
...
//**
// 5의 배수이 수는 "5의 배수입니다" 출력, 아니면 "아닙니다" 출력
// 조건 : 숫자%5 ===0
//참 : "5의 배수입니다"
//거짓 : "아닙니다"
//  */
